...
//  if(digitalRead(gpioLuz) != lastStatusLampada){
//    lastStatusLampada = digitalRead(gpioLuz);
//    if(digitalRead(gpioLuz)){
//      webSocket.sendTXT(build_payload(socket_payload, 0, idClient, gpioLuz, 0, 1),7);
//      TelnetClient.println("[STA] envou up date - lampada on");
//    } else {
//      webSocket.sendTXT(build_payload(socket_payload, 0, idClient, gpioLuz, 0, 0),7);
